...
- **Localization:** Every user-facing string **must** use `"key".localized()`. Keys live in all 10 `*.lproj/Localizable.strings` files.
...
| `CheapSeek/AppLanguage.swift` | Single source of truth for the 10 supported languages |
