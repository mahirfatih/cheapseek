...
- **Testing:** XCTest unit tests (133, incl. security + config) + XCUITest (app launch + best-effort menu bar checks)
...
- Suites: `PeakCalculatorTests` (38), `CountdownFormatterTests` (7), `AppSettingsTests` (6), `AppModelTests` (7), `MenuBarLabelTests` (6), `NotificationManagerTests` (5), `NotificationPlannerTests` (10), `HistoryAggregatorTests` (8), `HistoryStoreTests` (17), `LocalizationTests` (4), `PricingConfigTests` (6), `TimeZoneCatalogTests` (6), `TimeZoneLabelTests` (5), `SecurityRegressionTests` (8) — **133 unit tests**, plus `CheapSeekUITests` (app launch + best-effort menu bar checks).
